...
public class CreatedDateTest extends TestBase {
	@Test
	public void reportTest() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		final WebElement users = driver.findElement(By.xpath("//option[@value='80']"));
		users.click();
